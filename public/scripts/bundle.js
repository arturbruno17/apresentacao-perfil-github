...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar valueInput = document.querySelector('input');\nvar repositories = [];\nvar ulElement = document.getElementById('repo-list');\nvar buttonElement = document.getElementById('button-submit');\nvar imageUser = document.getElementById('img-user');\nvar bioUser = document.getElementById('bio');\nvar followersUser = document.getElementById('followers'); // Função para zerar os valores após ser feita a requisição novamente\n\nfunction reset() {\n  repositories = [];\n  ulElement.innerHTML = '';\n  imageUser.style.display = 'none';\n  bioUser.innerHTML = '';\n  followersUser.innerHTML = '';\n}\n\nbuttonElement.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n  var dataUser, repositoryUser, _dataUser$data, avatar_url, bio, followers;\n\n  return regeneratorRuntime.wrap(function _callee$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          // Zerando os repositórios obtidos na pesquisa passada\n          reset(); // Fazendo a requisição na API do GitHub\n\n          _context.prev = 1;\n          _context.next = 4;\n          return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"https://api.github.com/users/\".concat(valueInput.value));\n\n        case 4:\n          dataUser = _context.sent;\n          _context.next = 7;\n          return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"https://api.github.com/users/\".concat(valueInput.value, \"/repos\"));\n\n        case 7:\n          repositoryUser = _context.sent;\n          _dataUser$data = dataUser.data, avatar_url = _dataUser$data.avatar_url, bio = _dataUser$data.bio, followers = _dataUser$data.followers; // Mostrando dados do usuário na tela\n\n          imageUser.setAttribute('src', avatar_url);\n          imageUser.style.display = 'block';\n          bioUser.innerHTML = bio;\n          followersUser.innerHTML = \"Seguidores: \".concat(followers); // Mostrar um modal caso o usuário não tenha repositório\n\n          if (repositoryUser.data.length == 0) {\n            $(\"#withoutRepository\").modal('show');\n          }\n\n          repositoryUser.data.forEach(function (value) {\n            repositories.push({\n              title: value.name,\n              description: value.description,\n              html_url: value.html_url\n            });\n          });\n          repositories.forEach(function (value) {\n            var liElement = document.createElement('li');\n            var cardDiv = document.createElement('div');\n            cardDiv.className = 'card';\n            var cardBodyDiv = document.createElement('div');\n            cardBodyDiv.className = 'card-body';\n            var h5Element = document.createElement('h5');\n            h5Element.classList = 'card-title';\n            h5Element.innerHTML = value.title;\n            var paragraph = document.createElement('p');\n            paragraph.className = 'card-text';\n            paragraph.innerHTML = value.description;\n            var link = document.createElement('a');\n            link.setAttribute('href', value.html_url);\n            link.setAttribute('target', '_blank');\n            link.className = 'btn btn-dark';\n            link.innerHTML = 'Acessar';\n            cardBodyDiv.appendChild(h5Element);\n            cardBodyDiv.appendChild(paragraph);\n            cardBodyDiv.append(link);\n            cardDiv.appendChild(cardBodyDiv);\n            liElement.appendChild(cardDiv);\n            ulElement.appendChild(liElement);\n          });\n          _context.next = 21;\n          break;\n\n        case 18:\n          _context.prev = 18;\n          _context.t0 = _context[\"catch\"](1);\n          // Mostrar modal caso o não exista\n          $(\"#notFoundUser\").modal('show');\n\n        case 21:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, _callee, null, [[1, 18]]);\n}));\n\n//# sourceURL=webpack:///./src/main.js?");
